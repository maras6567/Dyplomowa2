...
<div class="container pt-5">
    <div class="row">
                        ...
                        <div class="col-6 col-md-6 col-lg-4 mb-3">
                            <div class="card h-100 border-0">
                                ...
                                @guest  
                                    disabled
                                @endguest>
                                <i class="fa-solid fa-cart-plus"></i>Dodaj do ulubionych
                                </button>
                            </div>
                        </div> 
                    @endforeach   
        ...
        <form class="col-md-4 order-md-1 col-lg-3 sidebar-filter">
            <h3 class="mt-0 mb-5">{{__('translate.welcome.products')}} <span class="text-primary">{{ count($products)}}</span> </h3>
            <h6 class="text-uppercase font-weight-bold mb-3">{{__('translate.welcome.categories')}}</h6>
            ...
            <h6 class="text-uppercase mt-5 mb-3 font-weight-bold">{{__('translate.welcome.price')}}</h6>
            ...
            <div class="divider mt-5 mb-5 border-bottom border-secondary"></div>
            <a href="#" class="btn btn-lg btn-block btn-primary mt-5" id="filter-button"><i class="fa-solid fa-magnifying-glass"></i></i> {{__('translate.welcome.filter')}}</a>
        </form>  
    </div>
</div>
